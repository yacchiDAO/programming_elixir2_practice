defmodule Issues.TableFormatter do
  ...
  We caluculate the width of each column to fit the longest element
  in that column.
  """
  ...
  of columns, return a list containing list of the data in
  ...
  @doc """
  Return a format string that hard-codes the width of a set of columns.
